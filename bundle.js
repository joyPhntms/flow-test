  ...
  (n.n = (e) => {
    ...
    (() => {
        ...
        ge = class extends de {
          ...
          _initTextures() {
            this._fbo = new Y(
              ve.numParticles,
              ve.numParticles,
              { type: E.FLOAT, minFilter: E.NEAREST, magFilter: E.NEAREST },
              4
            );
          }
          _initViews() {
            ...
            const t = [],
              n = [],
              r = [];
            for (let e = 0; e < ve.numParticles; e++)
              for (let o = 0; o < ve.numParticles; o++)
                t.push([o / ve.numParticles, e / ve.numParticles]),
                  n.push([me(), me(), me()]),
                  r.push([me(1), me(1), me(1)]);
            const o = new F()
              .setMesh(D())
              .useProgram(
                Ee,
            ...
            this._fbo.write.bind(),
              E.clear(0, 0, 0, 0),
              o.uniform("uSeed", me(1e3)).draw(),
              this._fbo.write.unbind(),
              this._fbo.swap();
            const i = new b(E.POINTS).bufferVertex(n).bufferTexCoord(t);
          ...
          update() {
            this._drawSim
              ...
              .uniform("uNoiseScale", ve.noiseScale)
              .uniform("uNoiseStrength", ve.noiseStrength)
              .uniform("uFlowSpeed", ve.flowSpeed)
              .uniform("uAccX", ve.acc_X)
              .uniform("uAccY", ve.acc_Y)
              .draw(),
              this._fbo.swap();
          }
          render() {
            E.clear(0.1, 0.1, 0.1, 1),
              ...
              this._drawParticles
                ...
                .uniform("uParticleSize", ve.particleSize)
                .uniform("uBrightness", ve.brightness)
                .uniform("uColorEdge1", ve.colorEdge1)
                .uniform("uColorEdge2", ve.colorEdge2)
                .uniform("uColorEdge3", ve.colorEdge3)
                .uniform("uColorEdge4", ve.colorEdge4)
                .uniform(
                  "uColors[0]",
                  ve.color1.map((e) => e / 255)
                )
                .uniform(
                  "uColors[1]",
                  ve.color2.map((e) => e / 255)
                )
                .uniform(
                  "uColors[2]",
                  ve.color3.map((e) => e / 255)
                )
                .uniform(
                  "uColors[3]",
                  ve.color4.map((e) => e / 255)
                )
                .uniform(
                  "uColors[4]",
                  ve.color5.map((e) => e / 255)
                )
                .uniform("uPosOffset", [ve.posX, ve.posY, ve.posZ])
                .draw(),
              ve.lockCamera
                ? this.changeCamera ||
      ...
      const Re = {
          ...
          init: (e = !0) => {
            be = e;
            const t = Te()(window.location.search, !0);
            let n = {};
      ...
      document.body.appendChild(Le.domElement),
        ce.addEF(() => {
          Le.update();
        });
      var Ie = Array.prototype.forEach,
        ...
        Pe = {
          ...
          compose: function () {
            ...
            return function () {
              for (var t = Oe.call(arguments), n = e.length - 1; n >= 0; n--)
                t = [e[n].apply(this, t)];
              return t[0];
            };
          },
          each: function (e, t, n) {
            if (e)
              if (Ie && e.forEach && e.forEach === Ie) e.forEach(t, n);
          ...
          toArray: function (e) {
            return e.toArray ? e.toArray() : Oe.call(e);
          },
        ...
        Be = function () {
          De = !1;
          var e = arguments.length > 1 ? Pe.toArray(arguments) : arguments[0];
          return (
            Pe.each(Fe, function (t) {
              if (t.litmus(e))
                return (
                  Pe.each(t.conversions, function (t, n) {
                    if (((Ue = t.read(e)), !1 === De && !1 !== Ue))
                      return (
                        (De = Ue),
                        (Ue.conversionName = n),
                        (Ue.conversion = t),
        ...
        We = (function () {
          function e() {
            if (
              (Xe(this, e),
              (this.__state = Be.apply(this, arguments)),
              !1 === this.__state)
            )
      ...
      function qe(e, t, n) {
        Object.defineProperty(e, t, {
          get: function () {
            return (
              "RGB" === this.__state.space || We.recalculateRGB(this, t, n),
              this.__state[t]
            );
          },
          set: function (e) {
            "RGB" !== this.__state.space &&
              (We.recalculateRGB(this, t, n), (this.__state.space = "RGB")),
              (this.__state[t] = e);
          },
        });
      }
      function Ke(e, t) {
        Object.defineProperty(e, t, {
          get: function () {
            return (
              "HSV" === this.__state.space || We.recalculateHSV(this),
              this.__state[t]
            );
          },
          set: function (e) {
            "HSV" !== this.__state.space &&
              (We.recalculateHSV(this), (this.__state.space = "HSV")),
              (this.__state[t] = e);
          },
        });
      }
      (We.recalculateRGB = function (e, t, n) {
        if ("HEX" === e.__state.space)
          e.__state[t] = Ge.component_from_hex(e.__state.hex, n);
        else {
          if ("HSV" !== e.__state.space)
            throw new Error("Corrupted color state");
          Pe.extend(
            e.__state,
            Ge.hsv_to_rgb(e.__state.h, e.__state.s, e.__state.v)
          );
        }
      }),
        (We.recalculateHSV = function (e) {
          var t = Ge.rgb_to_hsv(e.r, e.g, e.b);
          Pe.extend(e.__state, { s: t.s, v: t.v }),
            Pe.isNaN(t.h)
              ? Pe.isUndefined(e.__state.h) && (e.__state.h = 0)
              : (e.__state.h = t.h);
        }),
        (We.COMPONENTS = ["r", "g", "b", "h", "s", "v", "hex", "a"]),
        qe(We.prototype, "r", 2),
        qe(We.prototype, "g", 1),
        qe(We.prototype, "b", 0),
        Ke(We.prototype, "h"),
        ...
        Object.defineProperty(We.prototype, "hex", {
          get: function () {
            return (
              "HEX" !== this.__state.space &&
                ((this.__state.hex = Ge.rgb_to_hex(this.r, this.g, this.b)),
      ...
      var Je = /(\d+(\.\d+)?)px/;
      function $e(e) {
        if ("0" === e || Pe.isUndefined(e)) return 0;
        var t = e.match(Je);
        return Pe.isNull(t) ? 0 : parseFloat(t[1]);
      }
      var et = {
          ...
          makeFullscreen: function (e, t, n) {
            var r = n,
              o = t;
            Pe.isUndefined(o) && (o = !0),
              Pe.isUndefined(r) && (r = !0),
          ...
          fakeEvent: function (e, t, n, r) {
            ...
            Pe.defaults(a, r), e.dispatchEvent(a);
          },
          ...
          getWidth: function (e) {
            ...
            return (
              $e(t["border-left-width"]) +
              $e(t["border-right-width"]) +
              $e(t["padding-left"]) +
              $e(t["padding-right"]) +
              $e(t.width)
            );
          ...
          getHeight: function (e) {
            var t = getComputedStyle(e);
            return (
              $e(t["border-top-width"]) +
              $e(t["border-bottom-width"]) +
              $e(t["padding-top"]) +
              $e(t["padding-bottom"]) +
              $e(t.height)
            );
        ...
        nt = (function (e) {
          function t(e, n, r) {
            ...
            var o = je(
              ...
              a = o;
            if (
              ((o.__select = document.createElement("select")), Pe.isArray(i))
            ) {
              var s = {};
            ...
            return (
              ...
              o.updateDisplay(),
              et.bind(o.__select, "change", function () {
          ...
          return (
            ...
            ke(t, [
              ...
              },
              {
                key: "updateDisplay",
                value: function () {
                  return et.isActive(this.__select)
                    ? this
        ...
        rt = (function (e) {
          function t(e, n) {
            ...
            return (
              ...
              et.bind(r.__input, "keyup", i),
              et.bind(r.__input, "change", i),
              et.bind(r.__input, "blur", function () {
                o.__onFinishChange && o.__onFinishChange.call(o, o.getValue());
              }),
              et.bind(r.__input, "keydown", function (e) {
      ...
      var it = (function (e) {
          function t(e, n, r) {
            ...
            return (
              ...
              (o.__precision = ot(o.__impliedStep)),
              o
            );
          }
          return (
        ...
        at = (function (e) {
          function t(e, n, r) {
            ...
            function u() {
              et.unbind(window, "mousemove", c),
                et.unbind(window, "mouseup", u),
                s();
            }
            return (
              (o.__input = document.createElement("input")),
              o.__input.setAttribute("type", "text"),
              et.bind(o.__input, "change", function () {
                var e = parseFloat(i.__input.value);
                Pe.isNaN(e) || i.setValue(e);
              }),
              et.bind(o.__input, "blur", function () {
                s();
              }),
              et.bind(o.__input, "mousedown", function (e) {
                et.bind(window, "mousemove", c),
                  et.bind(window, "mouseup", u),
                  (a = e.clientY);
              }),
              et.bind(o.__input, "keydown", function (e) {
                13 === e.keyCode &&
      ...
      var ct = (function (e) {
          function t(e, n, r, o, i) {
            ...
            function c(e) {
              ...
              return (
                s.setValue(st(e.clientX, t.left, t.right, s.__min, s.__max)), !1
              );
            }
            function u() {
              et.unbind(window, "mousemove", c),
            ...
            function l(e) {
              ...
              s.setValue(st(t, n.left, n.right, s.__min, s.__max));
            }
            function h() {
              et.unbind(window, "touchmove", l),
                et.unbind(window, "touchend", h),
                s.__onFinishChange && s.__onFinishChange.call(s, s.getValue());
            }
            return (
              (a.__background = document.createElement("div")),
              (a.__foreground = document.createElement("div")),
              et.bind(a.__background, "mousedown", function (e) {
                document.activeElement.blur(),
                  et.bind(window, "mousemove", c),
                  et.bind(window, "mouseup", u),
                  c(e);
              }),
              et.bind(a.__background, "touchstart", function (e) {
                1 === e.touches.length &&
                  (et.bind(window, "touchmove", l),
                  et.bind(window, "touchend", h),
                  l(e));
              }),
              et.addClass(a.__background, "slider"),
              et.addClass(a.__foreground, "slider-fg"),
              a.updateDisplay(),
        ...
        ut = (function (e) {
          function t(e, n, r) {
            ...
            return (
              ...
              et.bind(o.__button, "click", function (e) {
                return e.preventDefault(), i.fire(), !1;
              }),
              et.addClass(o.__button, "button"),
        ...
        lt = (function (e) {
          function t(e, n) {
            ...
            (r.__color = new We(r.getValue())), (r.__temp = new We(0));
            var o = r;
            (r.domElement = document.createElement("div")),
              et.makeSelectable(r.domElement, !1),
              ...
              et.bind(r.__input, "blur", h),
              et.bind(r.__selector, "mousedown", function () {
                et.addClass(this, "drag").bind(window, "mouseup", function () {
                  et.removeClass(o.__selector, "drag");
                });
              }),
              et.bind(r.__selector, "touchstart", function () {
                et.addClass(this, "drag").bind(window, "touchend", function () {
                  et.removeClass(o.__selector, "drag");
                });
              });
            var i,
            ...
            function s(e) {
              _(e),
                et.bind(window, "mousemove", _),
                et.bind(window, "touchmove", _),
                et.bind(window, "mouseup", u),
                et.bind(window, "touchend", u);
            }
            function c(e) {
              f(e),
                et.bind(window, "mousemove", f),
                et.bind(window, "touchmove", f),
                et.bind(window, "mouseup", l),
                et.bind(window, "touchend", l);
            }
            function u() {
              et.unbind(window, "mousemove", _),
                et.unbind(window, "touchmove", _),
                et.unbind(window, "mouseup", u),
                et.unbind(window, "touchend", u),
                d();
            }
            function l() {
              et.unbind(window, "mousemove", f),
                et.unbind(window, "touchmove", f),
                et.unbind(window, "mouseup", l),
                et.unbind(window, "touchend", l),
                d();
            }
            function h() {
              var e = Be(this.value);
            ...
            return (
              ...
              Pe.extend(r.__field_knob.style, {
                position: "absolute",
                width: "12px",
                height: "12px",
                border:
              ...
              Pe.extend(r.__saturation_field.style, {
                width: "100px",
                height: "100px",
              ...
              dt(a, "top", "rgba(0,0,0,0)", "#000"),
              Pe.extend(r.__hue_field.style, {
                width: "15px",
                height: "100px",
                border: "1px solid #555",
                cursor: "ns-resize",
              ...
              et.bind(r.__saturation_field, "mousedown", s),
              et.bind(r.__saturation_field, "touchstart", s),
              et.bind(r.__field_knob, "mousedown", s),
              et.bind(r.__field_knob, "touchstart", s),
              et.bind(r.__hue_field, "mousedown", c),
              et.bind(r.__hue_field, "touchstart", c),
                  ...
                  if (!1 !== e) {
                    ...
                    Pe.each(
                      ...
                      function (n) {
                        if (
                          !Pe.isUndefined(e[n]) &&
                          !Pe.isUndefined(this.__color.__state[n]) &&
                      ...
                      t && Pe.extend(this.__color.__state, e);
                  }
                  Pe.extend(this.__temp.__state, this.__color.__state),
                    (this.__temp.a = 1);
                  var n =
                      this.__color.v < 0.5 || this.__color.s > 0.5 ? 255 : 0,
                    r = 255 - n;
                  Pe.extend(this.__field_knob.style, {
      ...
      var _t = function (e, t) {
          var n = e[t];
          return Pe.isArray(arguments[2]) || Pe.isObject(arguments[2])
            ? new nt(e, t, arguments[2])
            : Pe.isNumber(n)
            ? Pe.isNumber(arguments[2]) && Pe.isNumber(arguments[3])
              ? Pe.isNumber(arguments[4])
                ? new ct(e, t, arguments[2], arguments[3], arguments[4])
                : new ct(e, t, arguments[2], arguments[3])
              : Pe.isNumber(arguments[4])
              ? new at(e, t, {
                  min: arguments[2],
                  max: arguments[3],
              ...
              : new at(e, t, { min: arguments[2], max: arguments[3] })
            : Pe.isString(n)
            ? new rt(e, t)
            : Pe.isFunction(n)
            ? new ut(e, t, "")
        ...
        pt = (function () {
          function e() {
            Xe(this, e),
              ...
              Pe.extend(this.backgroundElement.style, {
              ...
              et.makeFullscreen(this.backgroundElement),
              (this.backgroundElement.style.position = "fixed"),
              (this.domElement = document.createElement("div")),
              Pe.extend(this.domElement.style, {
                position: "fixed",
                display: "none",
                zIndex: "1001",
                opacity: 0,
            ...
            var t = this;
            et.bind(this.backgroundElement, "click", function () {
              t.hide();
            });
          }
          return (
                  ...
                  var e = this,
                    t = function t() {
                      (e.domElement.style.display = "none"),
                        ...
                        et.unbind(e.domElement, "webkitTransitionEnd", t),
                        et.unbind(e.domElement, "transitionend", t),
                        et.unbind(e.domElement, "oTransitionEnd", t);
                    };
                  et.bind(this.domElement, "webkitTransitionEnd", t),
                    et.bind(this.domElement, "transitionend", t),
                    et.bind(this.domElement, "oTransitionEnd", t),
              ...
              },
              {
                ...
                value: function () {
                  (this.domElement.style.left =
                    window.innerWidth / 2 -
                    et.getWidth(this.domElement) / 2 +
                    "px"),
                    (this.domElement.style.top =
                      window.innerHeight / 2 -
                      et.getHeight(this.domElement) / 2 +
                      "px");
                },
              },
            ]),
      ...
      var mt = "Default",
        ...
        At = function e(t) {
          ...
          (this.domElement = document.createElement("div")),
            ...
            et.addClass(this.domElement, "dg"),
            (this.__folders = {}),
            (this.__controllers = []),
            ...
            Pe.isUndefined(r.load)
              ? (r.load = { preset: mt })
              : r.preset && (r.load.preset = r.preset),
            Pe.isUndefined(r.parent) && r.hideable && bt.push(this),
            (r.resizable = Pe.isUndefined(r.parent) && r.resizable),
            r.autoPlace && Pe.isUndefined(r.scrollable) && (r.scrollable = !0);
          var o,
            i = Et && "true" === localStorage.getItem(wt(0, "isLocal")),
            a = void 0,
            s = void 0;
          if (
            (Object.defineProperties(this, {
              ...
              closed: {
                ...
                set: function (t) {
                  (r.closed = t),
                    r.closed
                      ? et.addClass(n.__ul, e.CLASS_CLOSED)
                      : et.removeClass(n.__ul, e.CLASS_CLOSED),
                    this.onResize(),
                    n.__closeButton &&
              ...
              useLocalStorage: {
                ...
                set: function (e) {
                  Et &&
                    ((i = e),
                    e
                      ? et.bind(window, "unload", a)
                      : et.unbind(window, "unload", a),
                    localStorage.setItem(wt(0, "isLocal"), e));
                },
              },
            }),
            Pe.isUndefined(r.parent))
          ) {
            if (
              ((this.closed = r.closed || !1),
              et.addClass(this.domElement, e.CLASS_MAIN),
              et.makeSelectable(this.domElement, !1),
              Et && i)
            ) {
              n.useLocalStorage = !0;
              var c = localStorage.getItem(wt(0, "gui"));
              c && (r.load = JSON.parse(c));
            }
            (this.__closeButton = document.createElement("div")),
              (this.__closeButton.innerHTML = e.TEXT_CLOSED),
              et.addClass(this.__closeButton, e.CLASS_CLOSE_BUTTON),
              r.closeOnTop
                ? (et.addClass(this.__closeButton, e.CLASS_CLOSE_TOP),
                  this.domElement.insertBefore(
                    this.__closeButton,
                    this.domElement.childNodes[0]
                  ))
                : (et.addClass(this.__closeButton, e.CLASS_CLOSE_BOTTOM),
                  this.domElement.appendChild(this.__closeButton)),
              et.bind(this.__closeButton, "click", function () {
                n.closed = !n.closed;
              });
          } else {
            void 0 === r.closed && (r.closed = !0);
            var u = document.createTextNode(r.name);
            et.addClass(u, "controller-name"),
              (s = yt(n, u)),
              et.addClass(this.__ul, e.CLASS_CLOSED),
              et.addClass(s, "title"),
              et.bind(s, "click", function (e) {
          ...
          r.autoPlace &&
            (Pe.isUndefined(r.parent) &&
              (gt &&
                ...
                et.addClass(xt, "dg"),
                et.addClass(xt, e.CLASS_AUTO_PLACE_CONTAINER),
                document.body.appendChild(xt),
                (gt = !1)),
              xt.appendChild(this.domElement),
              et.addClass(this.domElement, e.CLASS_AUTO_PLACE)),
            this.parent || Ot(n, r.width)),
            (this.__resizeHandler = function () {
              n.onResizeDebounced();
            }),
            et.bind(window, "resize", this.__resizeHandler),
            et.bind(this.__ul, "webkitTransitionEnd", this.__resizeHandler),
            et.bind(this.__ul, "transitionend", this.__resizeHandler),
            et.bind(this.__ul, "oTransitionEnd", this.__resizeHandler),
            this.onResize(),
            r.resizable && It(this),
            (a = function () {
              Et &&
                "true" === localStorage.getItem(wt(0, "isLocal")) &&
      ...
      function Rt(e) {
        et.unbind(window, "resize", e.__resizeHandler),
          e.saveToLocalStorageIfPossible &&
            et.unbind(window, "unload", e.saveToLocalStorageIfPossible);
      }
      function Mt(e, t) {
      ...
      function Ct(e, t, n, r) {
        ...
        var o = void 0;
        if (r.color) o = new lt(t, n);
        else {
          var i = [t, n].concat(r.factoryArgs);
          o = _t.apply(e, i);
        }
        r.before instanceof Ze && (r.before = r.before.__li),
          St(e, o),
          et.addClass(o.domElement, "c");
        var a = document.createElement("span");
        et.addClass(a, "property-name"), (a.innerHTML = o.property);
        var s = document.createElement("div");
        s.appendChild(a), s.appendChild(o.domElement);
        var c = yt(e, s, r.before);
        return (
          et.addClass(c, At.CLASS_CONTROLLER_ROW),
          o instanceof lt
            ? et.addClass(c, "color")
            : et.addClass(c, Ve(o.getValue())),
          (function (e, t, n) {
            if (
              ((n.__li = t),
              (n.__gui = e),
              Pe.extend(n, {
                options: function (t) {
                  if (arguments.length > 1) {
                    ...
                    return (
                      n.remove(),
                      Ct(e, n.object, n.property, {
                        before: r,
                        factoryArgs: [Pe.toArray(arguments)],
                      })
                    );
                  }
                  if (Pe.isArray(t) || Pe.isObject(t)) {
              ...
              var r = new at(n.object, n.property, {
                min: n.__min,
                max: n.__max,
                step: n.__step,
              });
              ...
              (n.min = Pe.compose(o, n.min)), (n.max = Pe.compose(o, n.max));
            } else
              n instanceof tt
                ? (et.bind(t, "click", function () {
                    et.fakeEvent(n.__checkbox, "click");
                  }),
                  et.bind(n.__checkbox, "click", function (e) {
                    e.stopPropagation();
                  }))
                : n instanceof ut
                ? (et.bind(t, "click", function () {
                    et.fakeEvent(n.__button, "click");
                  }),
                  et.bind(t, "mouseover", function () {
                    et.addClass(n.__button, "hover");
                  }),
                  et.bind(t, "mouseout", function () {
                    et.removeClass(n.__button, "hover");
                  }))
                : n instanceof lt &&
                  (et.addClass(t, "color"),
                  (n.updateDisplay = Pe.compose(function (e) {
                    return (t.style.borderLeftColor = n.__color.toString()), e;
                  }, n.updateDisplay)),
                  n.updateDisplay());
            n.setValue = Pe.compose(function (t) {
              return (
      ...
      function It(e) {
        ...
        function r() {
          et.removeClass(e.__closeButton, At.CLASS_DRAG),
            et.unbind(window, "mousemove", n),
            et.unbind(window, "mouseup", r);
        }
        function o(o) {
          return (
            o.preventDefault(),
            (t = o.clientX),
            et.addClass(e.__closeButton, At.CLASS_DRAG),
            et.bind(window, "mousemove", n),
            et.bind(window, "mouseup", r),
            !1
          );
        }
        (e.__resize_handle = document.createElement("div")),
          Pe.extend(e.__resize_handle.style, {
            width: "6px",
            marginLeft: "-3px",
            height: "200px",
            cursor: "ew-resize",
          ...
          et.bind(e.__resize_handle, "mousedown", o),
          et.bind(e.__closeButton, "mousedown", o),
      ...
      function Pt(e, t) {
        var n = {};
        return (
          Pe.each(e.__rememberedObjects, function (r, o) {
            var i = {},
              a = e.__rememberedObjectIndecesToControllers[o];
            Pe.each(a, function (e, n) {
      ...
      (At.toggleHide = function () {
        (Tt = !Tt),
          Pe.each(bt, function (e) {
            e.domElement.style.display = Tt ? "none" : "";
          });
      }),
        (At.CLASS_AUTO_PLACE = "a"),
        (At.CLASS_AUTO_PLACE_CONTAINER = "ac"),
        (At.CLASS_MAIN = "main"),
        (At.CLASS_CONTROLLER_ROW = "cr"),
        (At.CLASS_TOO_TALL = "taller-than-window"),
        (At.CLASS_CLOSED = "closed"),
        (At.CLASS_CLOSE_BUTTON = "close-button"),
        (At.CLASS_CLOSE_TOP = "close-top"),
        (At.CLASS_CLOSE_BOTTOM = "close-bottom"),
        (At.CLASS_DRAG = "drag"),
        (At.DEFAULT_WIDTH = 245),
        (At.TEXT_CLOSED = "Close Controls"),
        (At.TEXT_OPEN = "Open Controls"),
        (At._keydownHandler = function (e) {
          "text" === document.activeElement.type ||
            (72 !== e.which && 72 !== e.keyCode) ||
            At.toggleHide();
        }),
        et.bind(window, "keydown", At._keydownHandler, !1),
        Pe.extend(At.prototype, {
          add: function (e, t) {
            return Ct(this, e, t, {
          ...
          destroy: function () {
            ...
            this.autoPlace && xt.removeChild(this.domElement);
            var e = this;
            Pe.each(this.__folders, function (t) {
              e.removeFolder(t);
            }),
              et.unbind(window, "keydown", At._keydownHandler, !1),
              Rt(this);
          },
          addFolder: function (e) {
            ...
            var n = new At(t);
            this.__folders[e] = n;
            var r = yt(this, n.domElement);
            return et.addClass(r, "folder"), n;
          },
          removeFolder: function (e) {
            this.__ul.removeChild(e.domElement.parentElement),
              ...
              Rt(e);
            var t = this;
            Pe.each(e.__folders, function (t) {
              e.removeFolder(t);
            }),
              Pe.defer(function () {
                t.onResize();
          ...
          onResize: function () {
            var e = this.getRoot();
            if (e.scrollable) {
              var t = et.getOffset(e.__ul).top,
                n = 0;
              Pe.each(e.__ul.childNodes, function (t) {
                (e.autoPlace && t === e.__save_row) || (n += et.getHeight(t));
              }),
                window.innerHeight - t - 20 < n
                  ? (et.addClass(e.domElement, At.CLASS_TOO_TALL),
                    (e.__ul.style.height = window.innerHeight - t - 20 + "px"))
                  : (et.removeClass(e.domElement, At.CLASS_TOO_TALL),
          ...
          onResizeDebounced: Pe.debounce(function () {
            this.onResize();
          }, 50),
          remember: function () {
            if (
              (Pe.isUndefined(vt) &&
                ((vt = new pt()).domElement.innerHTML =
                  '<div id="dg-save" class="dg dialogue">\n\n  Here\'s the new load parameter for your <code>GUI</code>\'s constructor:\n\n  <textarea id="dg-new-constructor"></textarea>\n\n  <div id="dg-save-locally">\n\n    <input id="dg-local-storage" type="checkbox"/> Automatically save\n    values to <code>localStorage</code> on exit.\n\n    <div id="dg-local-explain">The values saved to <code>localStorage</code> will\n      override those passed to <code>dat.GUI</code>\'s constructor. This makes it\n      easier to work incrementally, but <code>localStorage</code> is fragile,\n      and your friends may not see the same values you do.\n\n    </div>\n\n  </div>\n\n</div>'),
              this.parent)
            )
              throw new Error("You can only call remember on a top level GUI.");
            var e = this;
            Pe.each(Array.prototype.slice.call(arguments), function (t) {
              0 === e.__rememberedObjects.length &&
                (function (e) {
                  var t = (e.__save_row = document.createElement("li"));
                  et.addClass(e.domElement, "has-save"),
                    e.__ul.insertBefore(t, e.__ul.firstChild),
                    et.addClass(t, "save-row");
                  var n = document.createElement("span");
                  (n.innerHTML = "&nbsp;"), et.addClass(n, "button gears");
                  var r = document.createElement("span");
                  (r.innerHTML = "Save"),
                    et.addClass(r, "button"),
                    et.addClass(r, "save");
                  var o = document.createElement("span");
                  (o.innerHTML = "New"),
                    et.addClass(o, "button"),
                    et.addClass(o, "save-as");
                  var i = document.createElement("span");
                  (i.innerHTML = "Revert"),
                    et.addClass(i, "button"),
                    et.addClass(i, "revert");
                  var a = (e.__preset_select =
                    document.createElement("select"));
                  if (
                    (e.load && e.load.remembered
                      ? Pe.each(e.load.remembered, function (t, n) {
                          Lt(e, n, n === e.preset);
                        })
                      : Lt(e, mt, !1),
                    et.bind(a, "change", function () {
                      for (var t = 0; t < e.__preset_select.length; t++)
                    ...
                    (document.getElementById("dg-save-locally").style.display =
                      ...
                      Nt(e, s),
                      et.bind(c, "change", function () {
                        (e.useLocalStorage = !e.useLocalStorage), Nt(e, s);
                      });
                  }
                  var u = document.getElementById("dg-new-constructor");
                  et.bind(u, "keydown", function (e) {
                    !e.metaKey ||
                      (67 !== e.which && 67 !== e.keyCode) ||
                      vt.hide();
                  }),
                    et.bind(n, "click", function () {
                    ...
                    et.bind(r, "click", function () {
                      e.save();
                    }),
                    et.bind(o, "click", function () {
                      var t = prompt("Enter a new preset name.");
                      t && e.saveAs(t);
                    }),
                    et.bind(i, "click", function () {
                      e.revert();
                    });
                })(e),
          ...
          getSaveObject: function () {
            ...
            return (
              ...
              this.__rememberedObjects.length > 0 &&
                ...
                (e.remembered[this.preset] = Pt(this))),
              (e.folders = {}),
              Pe.each(this.__folders, function (t, n) {
          ...
          save: function () {
            this.load.remembered || (this.load.remembered = {}),
              (this.load.remembered[this.preset] = Pt(this)),
              Mt(this, !1),
          ...
          saveAs: function (e) {
            this.load.remembered ||
              ((this.load.remembered = {}),
              (this.load.remembered[mt] = Pt(this, !0))),
              (this.load.remembered[e] = Pt(this)),
              (this.preset = e),
              Lt(this, e, !0),
              this.saveToLocalStorageIfPossible();
          },
          revert: function (e) {
            Pe.each(
              ...
              Pe.each(this.__folders, function (e) {
                e.revert(e);
              }),
              e || Mt(this.getRoot(), !1);
          },
          listen: function (e) {
            ...
            this.__listening.push(e), t && Ft(this.__listening);
          },
          updateDisplay: function () {
            Pe.each(this.__controllers, function (e) {
              e.updateDisplay();
            }),
              Pe.each(this.__folders, function (e) {
                e.updateDisplay();
      ...
      const Dt = (e) => {
        ...
        i.add(ve, "lockCamera").onFinishChange(t),
          i.add(Re, "refresh").name("RESTART"),
          i.add(r, "save").name("Save Settings"),
          i.add(Re, "reset").name("Reset Default"),
          i.open();
        const a = o.addFolder("Basic");
        a.add(ve, "posX", -10, 10, 0.01).onFinishChange(t),
          a.add(ve, "posY", -10, 10, 0.01).onFinishChange(t),
          a.add(ve, "posZ", -10, 10, 0.01).onFinishChange(t),
          a.open();
        const s = o.addFolder("Particles");
        s
          .add(ve, "numParticles", [128, 256, 300, 400, 500, 600])
          .onFinishChange(n),
          s.add(ve, "flowSpeed", 0.1, 4, 0.01).onFinishChange(t),
          s.add(ve, "particleSize", 0.1, 10, 0.01).onFinishChange(t),
          s.add(ve, "acc_X", -5, 5, 0.01).onFinishChange(t),
          s.add(ve, "acc_Y", -5, 5, 0.01).onFinishChange(t),
          s.add(ve, "noiseScale", 0.1, 2, 0.01).onFinishChange(t),
          s.add(ve, "noiseStrength", 0, 4, 0.01).onFinishChange(t),
          s.open();
        const c = o.addFolder("Colors");
        c.add(ve, "brightness", 0.1, 5, 0.01).onFinishChange(t),
          c.addColor(ve, "color1").onFinishChange(t),
          c.addColor(ve, "color2").onFinishChange(t),
          c.addColor(ve, "color3").onFinishChange(t),
          c.addColor(ve, "color4").onFinishChange(t),
          c.addColor(ve, "color5").onFinishChange(t),
          c.add(ve, "colorEdge1", 0, 1, 0.01).onFinishChange(t),
          c.add(ve, "colorEdge2", 0, 1, 0.01).onFinishChange(t),
          c.add(ve, "colorEdge3", 0, 1, 0.01).onFinishChange(t),
          c.add(ve, "colorEdge4", 0, 1, 0.01).onFinishChange(t),
          c.open();
      };
      let Bt, zt;
      var Gt;
      ...
      new Promise((e, t) => {
        ...
        function () {
          (zt = document.createElement("canvas")),
            ...
            E.init(zt, { alpha: !1, preserveDrawingBuffer: !0 }),
            (Bt = new ge()),
            Dt();
        },
        (e) => {
